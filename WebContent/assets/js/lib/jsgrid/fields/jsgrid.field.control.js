(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        uploadButtonClass:"jsgrid-edit-button ti-plus",
...
//             return this._createModeSwitchButton();
        ...
        _createUploadButton: function(item) {
            return this._createGridButton(this.addButtonClass, this.addButtonTooltip, function(grid, e) {
                // grid.editItem(item);
                // e.stopPropagation();
            },"upload");
        },
...
//                e.stopPropagation();
        ...
        _createGridButton: function(cls, tooltip, clickHandler,name) {
            var grid = this._grid;
