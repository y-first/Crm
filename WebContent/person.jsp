											...
											<div class="col-lg-6">
												...
												<div class="form-group">
													...
													<select name="unit" id="unit"
														...
														<c:forEach items="${unitlist}" var="list">
															<c:if test="${list.id==personnel.unit}">
																<option value="${list.id }" selected="selected">${list.name }</option>
															</c:if>
															<c:if test="${list.id!=group.unit}">
																<option value="${list.id }">${list.name }</option>
															</c:if>
															</c:forEach>
														<%-- <option value="${personnel.unit}">${personnel.unitname}</option> --%>
													</select>
													</c:if>
													<c:if test="${duty == '2' }">
													<select name="unit" id="unit"
												...
												<div class="form-group">
													<%-- <label>出团性质</label> <select name="aim"
														class="form-control">
														<c:if test="${personnel.aim=='交流'}">
															<option value="交流" selected="selected">交流</option>
															<option value="培训">培训</option>
															
														</c:if>
														<c:if test="${personnel.aim=='培训'}">
											...
											<div class="col-lg-12">
												<div class="form-group">
													...
													<textarea class="form-control" id="notetext" rows="8"
														cols="" name="infoabroad">${personnel.infoabroad }</textarea>
												</div>
											</div>
										</div>
										<div class="row">
